...
/*
 * Enable the use of assembly code.
 *
 */
...
/*
 * Enable storing the AES tables in ROM.
 *
 ...
 * Caller:  library/x509parse.c
 *
 * This module is required for (rare) MD2-signed X.509 certs.
 *
#define XYSSL_MD2_C
 */
 ...
 * Caller:  library/x509parse.c
 *
 * This module is required for (rare) MD4-signed X.509 certs.
 *
#define XYSSL_MD4_C
 */
